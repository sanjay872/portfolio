      ...
      <div className='w-1/2 flex flex-col item-start justify-start h-full gap-5'>
        ...
        <div className="flex w-full gap-4">
          ...
          <div className="flex gap-4">
            <Mail size={24} className="cursor-pointer hover:scale-105"/>
            <div className="flex flex-wrap gap-4">
            <a href="mailto:sanjaysakthivel2000@gmail.com" className="text-blue-500">sanjaysakthivel2000@gmail.com</a>
            |
            <a href="mailto:ssakthivel@hawk.iit.edu" className="text-blue-500">ssakthivel@hawk.iit.edu</a>
            </div>
          </div>
        </div>
      </div>
